...
{
  [CollectionDefinition(nameof(ClienteDadosHumanosAutoMockCollection))]
  public class ClienteDadosHumanosAutoMockCollection : ICollectionFixture<ClienteTestsFixture>
  { }
